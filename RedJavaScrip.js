    ...
    if(gameStart)
        {
            if(document.getElementById(btn).innerHTML == "Start")
            {
                ...
                {
                    document.getElementById(btn).style.backgroundColor = "#3C1518";
...
function hover(obj)
{
    ...
    if(document.getElementById(temp).innerHTML == "Start")
         {
            document.getElementById(temp).style.backgroundColor = "#5AB84F";
         }
    else
         {
            document.getElementById(temp).style.backgroundColor = "#95B8D1";
         }
}
...
function noHover(obj)
{
    ...
    if(document.getElementById(temp).innerHTML == "Start")
         {
            document.getElementById(temp).style.backgroundColor = "#6DE060";
         }
    else
         {
            document.getElementById(temp).style.backgroundColor = "#95B8D1";
